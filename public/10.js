...
/* harmony import */ var vue_code_highlight_themes_prism_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-code-highlight/themes/prism.css */ "./node_modules/vue-code-highlight/themes/prism.css");
/* harmony import */ var vue_code_highlight_themes_prism_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vue_code_highlight_themes_prism_css__WEBPACK_IMPORTED_MODULE_1__);
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_6__["library"].add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_7__["faSync"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_7__["faRedo"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_7__["faUserCog"], _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_7__["faPortrait"]);
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(BASE_URL + "/api/nation/details/".concat(this.id)).then(function (response) {
      if (response.status = 200) {
        _this.nation = response.data.data[0][0];
        _this.hq_nations = response.data.data[1], _this.hq_pictures = response.data.data[2];
      }
    }).catch(function (error) {
      return sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Error!", error, "error");
    });
  },
  components: {
    "font-awesome-icon": _fortawesome_vue_fontawesome__WEBPACK_IMPORTED_MODULE_8__["FontAwesomeIcon"],
  ...
  methods: {
    updateNation: function updateNation() {
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.put(BASE_URL + "/api/nation/details/" + this.nation.id, {
        nation: this.nation,
        user_id: this.currentUser.user.id
      }).then(function (response) {
        if (response.status == 200) {
          sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Success", "Nation Updated Successfully", "success");
          window.location.reload();
        }
      }).catch(function (error) {
        sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Error", error, "error");
      });
    },
    ...
    refreshCache: function refreshCache() {
      ...
      this.syncStatus = 1;
      this.syncPicture = 1;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(BASE_URL + "/api/nation/clear/cache", {
        nation_id: this.id,
        user_id: this.currentUser.user.id
      }).then(function (response) {
        if (response.status == 200) {
          ...
          sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Success", "Cache Refresed successfully", "success");
          axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(BASE_URL + "/api/nation/details/".concat(_this2.id)).then(function (response) {
            if (response.status = 200) {
    ...
    syncMembers: function syncMembers() {
      ...
      } else sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Error", "Select a hq to sync", "warning");
    },
    updateSyncMembers: function updateSyncMembers(url) {
      var _this3 = this;

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(BASE_URL + "/api/nation/update/members", {
    ...
    findMatchPersonAndUpdate: function findMatchPersonAndUpdate(results, index, next_url) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(BASE_URL + "/api/nation/update/match/person", {
        nation_id: this.nation.id,
        ...
        if (results.length - 1 == index) {
          if (next_url == null) {
            syncStatus = 0;
            axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(BASE_URL + "/api/nation/sync/member/log", {
    ...
    syncPictures: function syncPictures() {
      ...
      this.syncStatus = 1;
      this.syncPicture = 1;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(BASE_URL + "/api/nation/sync/imagen", {
        nation_id: this.id,
        user_id: this.currentUser.user.id
      }).then(function (response) {
        if (response.status == 200) {
          ...
          sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Success", "Image Sync successfully", "success");
        }
      }).catch(function (error) {
        return sweetalert__WEBPACK_IMPORTED_MODULE_5___default()("Error", error, "error");
      });
