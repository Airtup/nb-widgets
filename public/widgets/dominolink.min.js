...
function viewPersonDetail(o) {
    ...
    fetch("https://stage.nbwidgets.com/api/getPersonDetail", {
        ...
        "" != e.twitter && null != e.twitter ? document.querySelector("#person_twitter").innerHTML = '<a target="_blank" class="icon-orange" href="https://www.twitter.com/@'+e.twitter+'"><i class="fa fa-twitter"></i> </a>': document.querySelector("#person_twitter").innerHTML = ""
        "" != e.facebook && null != e.facebook ? document.querySelector("#person_facebook").innerHTML = '<a target="_blank" class="icon-orange" href="https://www.facebook.com/profile.php?id='+e.facebook+'"><i class="fa fa-facebook"></i> </a>': document.querySelector("#person_facebook").innerHTML = ""
