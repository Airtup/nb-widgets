...
var styles = '.tooltip-js { position: relative; display: inline-block; border-bottom: 1px dotted black; } .tooltip-js .tooltiptext { visibility: hidden; font-size: 1em; width: 170px; height:130px; background-color: orange; color: #fff; text-align: center; border-radius: 6px; padding: 5px 0; position: absolute; z-index: 1; bottom: 125%; left: 50%; margin-left: -60px; opacity: 0; transition: opacity 0.3s; } .tooltip-js .tooltiptext::after { content: ""; position: absolute; top: 100%; left: 50%; margin-left: -5px; border-width: 5px; border-style: solid; border-color: #555 transparent transparent transparent;} .tooltip-js:hover .tooltiptext { visibility: visible; opacity: 1; }';
...
function searchPerson() {
    ...
    searchMode = 1, fetch("https://stage.nbwidgets.com/api/getAllPeopleList", {
        ...
        r += '<div class="row" style="margin-left: 5px;margin-right: 5px;padding: 10px;">',
            ...
            r += '<button id="backtomain" class="btn btn-lg btn-myblue" style="display:none;font-size: 11px;font-weight: bold; float: right;margin-right:12px;margin-top:10px;">Back to Main</button>',
...
function setCallPeopleUrl_New() {
    ...
    fetch("https://stage.nbwidgets.com/api/getPeopleList", {
        ...
        r += '<div class="row" style="margin-left: 5px;margin-right: 5px;padding: 10px;">',
            ...
            r += '<p style="font-size:14px;"><i id="gotoFirstPage" class="fa fa-angle-double-left" style="color: ' + n + ';cursor:pointer;"></i> <i id="gotoPrevPage" class="fa fa-angle-left gotoPrevPage" style="color: ' + n + ';cursor:pointer;"></i> Page <span id="searchcurPage">' + searchcurPage + "</span> of " + searchtotalPage + ' pages, displaying <span id="searchstartend">1-' + i + "</span> of " + totalCnt + ' results <i id="gotoNextPage" class="fa fa-angle-right gotoNextPage" style="color: ' + s + ';cursor:pointer;"></i> <i id="gotoLastPage" class="fa fa-angle-double-right" style="color: ' + s + ';cursor:pointer;"></i></p>', r += "</div>", r += '<div class="col-md-4">',
            r += '<button id="exportPDF" onclick="exportToPDF()" class="btn btn-lg btn-orange tooltip-js" style="font-size: 12px;font-weight: bold; float: right;margin-top:10px;margin-right:5px; white-space: break-spaces;"><span class="tooltiptext">Please note: Only your most recent search query will be exported. If you have clicked the &quot;Back&quot; button, please redo your search again before exporting.</span>Export PDF</button>',
