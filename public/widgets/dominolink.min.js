...
function searchPerson() {
    ...
    searchMode = 1, fetch("https://stage.nbwidgets.com/api/getAllPeopleList", {
        ...
        var t = a.length % dominolink.itemsPerPage;
        searchtotalPage = (a.length - t) / dominolink.itemsPerPage, t && searchtotalPage++;
        ...
        r += '<div class="row" style="margin-left: 5px;margin-right: 5px;padding: 10px;">',
            ...
            r += '<button id="backtomain" class="btn btn-lg btn-myblue" style="display:none;font-size: 11px;font-weight: bold; float: right;margin-right:12px;margin-top:10px;display:none">Back to Main</button>',
...
function addSearchPersonContent(o, a) {
    if(o == null) return;
    var e = "";
    if (e += '<div class="person_' + a + ' row" style="margin-top:20px;border-bottom: 1px solid lightgrey;padding:10px;margin-left: 5px;margin-right: 5px;">',
        e += '<div class="col-md-2 col-sm-2 col-xs-4">',
        e += '<img id="perImg_' + a + '" src="' + o.profile_image + '" width="80%;" />',
        e += "</div>", e += '<div id="person_simple_' + a + '" class="col-md-7 col-sm-7 col-xs-8">',
        e += '<p style="font-size:14px;"><b>' + canShow('first_name',o.first_name)  + " " + canShow('last_name',o.last_name) + "</b></p>",
        null != o.occupation && "" != o.occupation) {
        var t = "";
        null != o.employer && "" != o.employer && null != o.employer && (t = ", " + o.employer), e += canShow('occupation','<p style="color:grey;text-transform:capitalize"><i class="fa fa-male"></i> ' + o.occupation + t + "</p>")
    }
    var i = 0,
        n = "";
    canShow('state','ok') != ""  && null != o.state && "" != o.state && (isoStates.hasOwnProperty(o.state) ? n = isoStates[o.state] : n += o.state, i = 1),
    canShow('country','ok') != ""  && "" != o.country && null != o.country && (n += 0 == i ? isoCountries[o.country_code] : ", " + isoCountries[o.country_code]),
    "" != n && (e += '<p style="color:grey;"><i class="fa fa-map-marker"></i> ' + n + "</p>"),
    canShow('industry','ok') != "" &&  null != o.industry && "" != o.industry && null != o.industry && (e += '<p style="color:grey;"><i class="fa fa-list"></i> ' + o.industry + "</p>"),
    canShow('email','ok') != "" &&  (e += '<p style="color:grey;"><i class="fa fa-envelope"></i> '),
    canShow('twitter','ok') != "" && null != o.twitter && (e += '<i class="fa fa-twitter"></i> '),
    canShow('facebook','ok') != "" && 1 == o.facebook && (e += '<i class="fa fa-facebook-f"></i> '),
    canShow('linked_in','ok') != "" && null != o.linked_in && (e += '<i class="fa fa-linkedin"></i>'),
    e += "</p>", e += "</div>", e += '<div class="col-md-3 col-sm-3">',
    e += '<button class="btn btn-myblue" style="font-weight: bold;float: right;" id="viewDetail_' + o.person_id + '" data-picture="' + o.profile_image + '" onclick="viewPersonDetail(' + o.person_id + ')">View profile</button>',
    e += "</div>", e += "</div>", document.querySelector("#personList").innerHTML += e;
}
window.onload = async function() {
    addStyle(styles);
    var srcStyle = document.createElement("link");
    srcStyle.rel = "stylesheet", srcStyle.href = "https://stage.nbwidgets.com/assets/dominolink.min.css", document.getElementsByTagName("head")[0].appendChild(srcStyle)
    ...
    await fetch("https://stage.nbwidgets.com/api/getPDFLogo", {
        method: 'POST',
        headers: myHeaders,
        body: JSON.stringify({
            "nation_slug": dominolink.nationSlug,
...
function viewPersonDetail(o) {
    ...
    fetch("https://stage.nbwidgets.com/api/getPersonDetail", {
        ...
        document.querySelector("#loaderModal").style.display = "none";
        var e = response;
        document.querySelector("#person_image").setAttribute("src", a), document.querySelector("#person_name").innerHTML = canShow('first_name',e.first_name) + " " + canShow('last_name',e.last_name);
        var t = "";
        if (canShow("email","ok") != '' && "" != e.email && (t += '<a class="icon-orange" href="mailto:' + e.email + '"><i class="fa fa-envelope"></i> </a>'),
            canShow("twitter_id","ok") != '' && null != e.twitter_id && (t += '<a class="icon-orange" target="_blank" href="https://twitter.com/intent/user?screen_name=' + e.twitter_login + '"><i class="fa fa-twitter"></i></a> '),
            canShow("has_facebook","ok") != '' && 1 == e.has_facebook && (t += '<a class="icon-orange" target="_blank" href="' + e.facebook_profile_url + '"><i class="fa fa-facebook-f"></i></a> '),
            canShow("linkedin_id","ok") != '' && null != e.linkedin_id && (t += '<a class="icon-orange" target="_blank" href="' + e.linkedin_profile + '"><i class="fa fa-linkedin"></i></a>'),
            document.querySelector("#person_icon").innerHTML = t,
            "" != e.occupation && null != e.occupation
            ) {
            var i = "fa fa-male";
            null != e.sex && "F" != e.sex || (i = "fa fa-female");
            var n = "";
            canShow("ocupation","ok") != '' && null != e.employer && "" != e.employer && null != e.employer && (n = ", " + e.employer), document.querySelector("#person_occupation").innerHTML = '<p style="color:grey;font-size:14px;text-transform:capitalize"><i class="' + i + '"></i> ' + e.occupation + n + "</p>";
        } else document.querySelector("#person_occupation").innerHTML = "";
        var s = "",
            r = "";
        if (null != e) {
            var l = 0;
            canShow("state","ok") != '' && null != e.state && "" != e.state && (isoStates.hasOwnProperty(e.state) ? r += isoStates[e.state] : r += e.state, l = 1),
            canShow("country","ok") != '' && isoCountries.hasOwnProperty(e.country_code) && (s = isoCountries[e.country_code]), "" != s && null != s && (r += 0 == l ? s : ", " + s),
            canShow("city","ok") != '' && "" != e.city && null != e.city ? document.querySelector("#person_city").innerHTML = '<i class="fa fa-send"></i> City: ' + e.city : document.querySelector("#person_city").innerHTML = ""
        }
        if ("" != r ? document.querySelector("#person_country").innerHTML = '<i class="fa fa-map-marker"></i> ' + r : document.querySelector("#person_country").innerHTML = "",
            "" != e.industry && null != e.industry && null != e.industry ? document.querySelector("#person_industry").innerHTML = '<i class="fa fa-list"></i> ' + e.industry : document.querySelector("#person_industry").innerHTML = "",
            "" != e.boards && null != e.boards && null != e.boards ? document.querySelector("#person_boards").innerHTML = "Boards:<br/>" + e.boards : document.querySelector("#person_boards").innerHTML = "",
            canShow("email","ok") != '' && "" != e.email && null != e.email ? document.querySelector("#person_email").innerHTML = '<i class="fa fa-envelope"></i> Email: <b onclick="sendEmail(\'' + e.email + '\')" class="text-blue">' + e.email + "</b>" : document.querySelector("#person_email").innerHTML = "",
            canShow("phone","ok") != '' && "" != e.phone && null != e.phone ? document.querySelector("#person_phone").innerHTML = '<i class="fa fa-phone"></i> Phone: ' + e.phone + " " : document.querySelector("#person_phone").innerHTML = "",
            "" != e.work_phone_number && null != e.work_phone_number ? document.querySelector("#person_work_phone").innerHTML = '<i class="fa fa-phone"></i> Work: ' + e.work_phone_number + " " : document.querySelector("#person_work_phone").innerHTML = "",
            "" != e.mobile && null != e.mobile ? document.querySelector("#person_mobile").innerHTML = '<i class="fa fa-mobile"></i> Mobile: ' + e.mobile + " " : document.querySelector("#person_mobile").innerHTML = "",
            null != e.home_address) {
            var d = "",
                c = 0;
        ...
        if(canShow("twitter","ok") != '' &&  "" != e.twitter && null != e.twitter){
            document.querySelector("#person_twitter").innerHTML = '<a target="_blank" class="icon-orange" href="https://www.twitter.com/@'+e.twitter+'"><i class="fa fa-twitter"></i> </a>';
        }else{
            document.querySelector("#person_twitter").innerHTML = "";
        }
        if(canShow("facebook","ok") != '' &&  "" != e.facebook && null != e.facebook){
            var urlF = "https://www.facebook.com/"+e.facebook;
            if(e.facebook.startsWith('http')) urlF = e.facebook;
...
function exportToPDF(){
    ...
    var icons = {
        'ocupation':"data:image/png;base64,",
        'mark':"data:image/png;base64,",
        'industry':"data:image/png;base64,",
        'email':"data:image/png;base64,",
        'phone':"data:image/png;base64,",
        'cell':"data:image/png;base64,",
        'location':"data:image/png;base64,"
    };
    ...
    //First calc height of rect
    var rectH = 40;
    for (var l = 0; l < 1; l++) {

        d = 0 == searchMode ? jsonData[l] : searchjsonData[l],
        ...
        var c = d.occupation;
        null == c && (c = "N/A");
        if(canShow('ocupation',c) != ''){
            rectH +=  15;
        }

        var p = d.country;
        //location
        if(canShow('country',p)!= ''){
            rectH +=  15;
        }
        ...
        var u = "",
            m = 0;
        "" != d.home_address && null != d.home_address && (u += 0 == m ? d.home_address : ", " + d.home_address, m = 1),
        "" != d.address2 && null != d.address2 && (u += 0 == m ? d.address2 : ", " + d.address2, m = 1),
        "" != d.address3 && null != d.address3 && (u += 0 == m ? d.address3 : ", " + d.address3, m = 1),
        "" != d.city && null != d.city && (u += 0 == m ? d.city : ", " + d.city, m = 1),
        "" != d.state && null != d.state && (u += 0 == m ? d.state : ", " + d.state, m = 1),
        "" != d.zip && null != d.zip && (u += 0 == m ? d.zip : ", " + d.zip, m = 1),
        "" != d.country_code && null != d.country_code && (u += 0 == m ? d.country_code : ", " + d.country_code, m = 1);

        if(canShow('industry',d.industry)!= ''){
            rectH +=  15;
        }

        if(canShow('email',d.email)!= ''){
            rectH +=  15;
        }

        var g = "N/A";
        null != d.phone && (g = d.phone);
        if(canShow('phone',g)!= ''){
            rectH +=  15;
        }

        var pw = "N/A";
        null != d.work_phone && (pw = d.work_phone);
        if(canShow('work_phone',pw)!= ''){
            rectH +=  15;
        }

        var v = "N/A";
        null != d.mobile && (v = d.mobile);
        if(canShow('mobile',v)!= ''){
            rectH +=  15;
        }

        "" == u && (u = "N/A");
        if(canShow('home_address',u)!= ''){
            rectH +=  15;
        }
        break;
    }
    ...
    for (var l = 0; l < r; l++) {
        ...
        var h = 50;
        d = 0 == searchMode ? jsonData[l] : searchjsonData[l],
        l && l % 4 == 0 && (a.addPage(), s = 0),

        //a.addImage(imgData, "JPEG", 35, 52 + s, 20, 120, "Icon1"),
        a.setDrawColor(0),
        a.setFillColor(244, 244, 244),
        a.rect(20, s + 20 , 580, rectH  , "F");

        a.setFontSize(11), a.setFontType("bold"),
        a.setTextColor(0, 0, 0),
        "" == d.first_name && "" == d.last_name ? a.text(30, h + s, "N/A") : a.text(30, h + s, canShow('first_name',d.first_name) + " " + canShow('last_name',d.last_name)),
        h +=  13;
        a.setFontSize(10), a.setFontType("Normal"), a.setTextColor(100);

        //ocupation
        var c = d.occupation;
        null == c && (c = "N/A");
        if(canShow('ocupation',c) != ''){
            a.addImage(icons.ocupation, "PNG", 35, (h - 8) + s, 10, 10, "ocupation"),
            a.text(48, h + s, c);
            h +=  15;
        }
        ...
        //location
        if(canShow('country',p)!= ''){
            a.addImage(icons.mark, "PNG", 35, (h - 8) + s, 10, 10, "mark"),
            a.text(48, h + s, "Location: " + p);
            h +=  15;
        }
        ...
        if(canShow('industry',d.industry)!= ''){
            a.addImage(icons.industry, "PNG", 35, (h -8) + s, 10, 10, "industry"),
            null == d.industry ? a.text(48, h + s, "Industry: N/A") : a.text(48, 89 + s, "Industry: " + d.industry),
            h +=  15;
        }

        if(canShow('email',d.email)!= ''){
            a.addImage(icons.email, "PNG", 35, (h -8) + s, 10, 10, "email"),
            a.text(48, h + s, "Email: " + d.email);
            h +=  15;
        }
        ...
        null != d.phone && (g = d.phone);
        if(canShow('phone',g)!= ''){
            a.addImage(icons.phone, "PNG", 35, (h -8) + s, 10, 10, "phone"),
            a.text(48, h + s, "Phone: " + g);
            h +=  15;
        }
        ...
        null != d.work_phone && (pw = d.work_phone);
        if(canShow('work_phone',pw)!= ''){
            a.addImage(icons.phone, "PNG", 35, (h -8) + s, 10, 10, "phone2"),
            a.text(48, h + s, "Work Phone: " + pw);
            h +=  15;
        }
        ...
        null != d.mobile && (v = d.mobile);
        if(canShow('mobile',v)!= ''){
            a.addImage(icons.cell, "PNG", 35, (h -8) + s, 10, 10, "cell"),
            a.text(48, h + s, "Mobile phone: " + v),
            h +=  15;
        }

        "" == u && (u = "N/A");
        if(canShow('home_address',u)!= ''){
            a.addImage(icons.location, "PNG", 35, (h - 8) + s, 10, 10, "location"),
            a.text(48, h + s, "Home address: " + u),
            h +=  15;
        }
        s += 190;
...
function canShow(field,value){
    //return value;
    //if(field == 'email') return '';
    /*if(field == 'country') return '';*/
    if(!dominolink.show_options.hasOwnProperty(field)) return value;
    if(dominolink.show_options[field]) return value;
    return '';
}
