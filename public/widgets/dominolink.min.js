...
function init() {
    ...
    dominolink_config.itemsPerPage = dominolink_config.itemsPerPage != null ? dominolink_config.itemsPerPage : 50;
    dominolink_config.show_options = {};
    a = "";
    a += '<div class="container mycontainer" style="margin-top:20px;width:100%;">', "true" == dominolink_config.showSearchForm && (a += addSearchContent()), a += '<div id="peopleList" class="row" style="margin-left: 5px;margin-right: 5px;margin-top: 30px;">', a += "</div>", a += '<div id="loaderModal" style="display:none;position:fixed;top:54%;left:47%;"></div>', a += '<div id="pagination" class="row" style="margin-left: 5px;margin-right: 5px;margin-top: 30px;">', a += '<button class="btn btn-success gotoNextPage" style="float:right;margin-right:10px;">Next</button>', a += '<input type="text" class="form-control" style="float:right;text-align:center;width:50px !important;min-width:50px !important;margin-right:10px;" id="pagenum" value="" />', a += '<button class="btn btn-success gotoPrevPage" style="float:right;margin-right:10px;">Prev</button>', a += "</div>";
    ...
    a += "</div>", o.innerHTML = a, "light" == dominolink_config.theme ? (document.querySelector(".mycontainer").style.backgroundColor = 'white', document.querySelector(".mycontainer").style.color = 'black') : "dark" == dominolink_config.theme && (document.querySelector(".mycontainer").style.backgroundColor = 'black', document.querySelector(".mycontainer").style.color = 'white'),
        fetch("https://stage.nbwidgets.com/api/getPDFDetail", {
            ...
            var a = response.data;
            dominolink_config.show_options = JSON.parse(a.show_options);
...
function searchPerson() {
    ...
    searchMode = 1, fetch("https://stage.nbwidgets.com/api/getAllPeopleList", {
        ...
        var t = a.length % dominolink_config.itemsPerPage;
        searchtotalPage = (a.length - t) / dominolink_config.itemsPerPage, t && searchtotalPage++;
        var i = dominolink_config.itemsPerPage;
        ...
        for (var l = 0; l < dominolink_config.itemsPerPage; l++) addSearchPersonContent(a[l], l)
...
function setCallPeopleUrl_New() {
    ...
    fetch("https://stage.nbwidgets.com/api/getPeopleList", {
        ...
        searchjsonData = a, searchcurPage = 1;
        var t = totalCnt % dominolink_config.itemsPerPage;
        searchtotalPage = (totalCnt - t) / dominolink_config.itemsPerPage, t && searchtotalPage++;
        var i = dominolink_config.itemsPerPage;
        1 == searchtotalPage && (i = a.length), (document.querySelector("#pagenum").value = 1);
        var n = "#DC772A",
            s = "#DC772A";
...
function canShow(field,value){
    ...
    if(!dominolink_config.show_options.hasOwnProperty(field)) return value;
    if(dominolink_config.show_options[field]) return value;
    return '';
}
