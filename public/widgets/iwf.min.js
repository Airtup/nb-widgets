...
function init() {
    ...
    a += "</div>", o.innerHTML = a, "light" == dominolink.theme ? (document.querySelector(".mycontainer").style.backgroundColor = 'white', document.querySelector(".mycontainer").style.color = 'black') : "dark" == dominolink.theme && (document.querySelector(".mycontainer").style.backgroundColor = 'black', document.querySelector(".mycontainer").style.color = 'white'),
        fetch("https://iwf.nbwidgets.com/api/getPDFDetail", {
            method: 'POST',
            headers: myHeaders,
            body: JSON.stringify({
    ...
    i.type = "text/javascript", i.src = "https://iwf.nbwidgets.com/assets/jspdf.js", document.getElementsByTagName("head")[0].appendChild(i);
    var n = document.createElement("script");
    n.type = "text/javascript", n.src = "https://iwf.nbwidgets.com/assets/fuse.js", document.getElementsByTagName("head")[0].appendChild(n)
}
...
function searchPerson() {
    ...
    searchMode = 1, fetch("https://iwf.nbwidgets.com/api/getAllPeopleList", {
        method: "POST",
        headers: myHeaders,
        body: JSON.stringify({
            "nation_slug": dominolink.nationSlug,
...
function setCallPeopleUrl_New() {
    ...
    document.querySelector("#peopleList").style.display = "none";
    document.querySelector("#loaderModal").style.display = "block";
    fetch("https://iwf.nbwidgets.com/api/getPeopleList", {
        method: 'POST',
        headers: myHeaders,
        body: JSON.stringify({
            "nation_slug": dominolink.nationSlug,
...
window.onload = async function() {
    ...
    srcStyle.rel = "stylesheet", srcStyle.href = "https://iwf.nbwidgets.com/assets/dominolink.min.css", document.getElementsByTagName("head")[0].appendChild(srcStyle)
    ...
    await fetch("https://iwf.nbwidgets.com/api/getPDFLogo", {
        method: 'POST',
        headers: myHeaders,
        body: JSON.stringify({
            "nation_slug": dominolink.nationSlug,
...
function viewPersonDetail(o) {
    ...
    document.querySelector("#loaderModal").style.display = "block";
    fetch("https://iwf.nbwidgets.com/api/getPersonDetail", {
        method: 'POST',
        headers: myHeaders,
        body: JSON.stringify({
            "nation_slug": dominolink.nationSlug,
        ...
        if (null != e.primary_address) {
            var l = 0;
            canShow("state","ok") != '' && null != e.primary_address.state && "" != e.primary_address.state && (isoStates.hasOwnProperty(e.primary_address.state) ? r += isoStates[e.primary_address.state] : r += e.primary_address.state, l = 1),
            canShow("country","ok") != '' && isoCountries.hasOwnProperty(e.primary_address.country_code) && (s = isoCountries[e.primary_address.country_code]), "" != s && null != s && (r += 0 == l ? s : ", " + s),
                canShow("city","ok") != '' && "" != e.primary_address.city && null != e.primary_address.city ? document.querySelector("#person_city").innerHTML = '<i class="fa fa-send"></i> City: ' + e.primary_address.city : document.querySelector("#person_city").innerHTML = ""
        }
